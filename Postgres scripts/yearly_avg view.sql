-- View: public.yearly_avg

-- DROP VIEW public.yearly_avg;

CREATE OR REPLACE VIEW public.yearly_avg
 AS
 SELECT air_pollution.city,
   ...
   FROM air_pollution
  GROUP BY air_pollution.city, air_pollution.population
  ORDER BY (avg(air_pollution.aqi)::numeric(10,2)) DESC;

ALTER TABLE public.yearly_avg
    OWNER TO postgres;
